...
public class UsersDAO {
	...
	private final RowMapper<User> userRowMapper = (rs, rowNum) -> new User(rs.getString("LOGIN"), rs.getString("FIRST_NAME"), rs.getString("LAST_NAME"), rs.getBoolean("IS_ADMIN"));
